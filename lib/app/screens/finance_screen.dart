...
class FinanceScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (team == null) {
      return Center(child: Text(l10n.finance_noTeam));
    }
    ...
    return ListView(
      ...
      children: [
        Text(l10n.finance_title, style: Theme.of(context).textTheme.headlineSmall),
        const SizedBox(height: 12),
        _tile(context, l10n.finance_payroll, formatMoney(context, snap.payroll)),
        _tile(context, l10n.finance_cap, formatMoney(context, snap.cap)),
        _tile(context, l10n.finance_capSpace, formatMoney(context, snap.capSpace)),
        _tile(context, l10n.finance_firstApron, formatMoney(context, snap.firstApron)),
        _tile(context, l10n.finance_secondApron, formatMoney(context, snap.secondApron)),
        _tile(context, l10n.finance_tax, formatMoney(context, snap.taxOwed)),
        _tile(context, l10n.finance_cash, formatMoney(context, cash)),
        _tile(context, l10n.finance_status, _capStatusLabel(l10n, snap.status)),
