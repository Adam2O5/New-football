...
_$CapExceptionImpl _$$CapExceptionImplFromJson(Map<String, dynamic> json) =>
    _$CapExceptionImpl(
...
Map<String, dynamic> _$$CapExceptionImplToJson(_$CapExceptionImpl instance) =>
    <String, dynamic>{
...
_$TeamFinanceImpl _$$TeamFinanceImplFromJson(Map<String, dynamic> json) =>
    _$TeamFinanceImpl(
...
Map<String, dynamic> _$$TeamFinanceImplToJson(_$TeamFinanceImpl instance) =>
    <String, dynamic>{
