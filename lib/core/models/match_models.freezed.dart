...
@useResult
$Res call({
 String homeTeamId, String awayTeamId, int homeGoals, int awayGoals, TeamMatchStats homeStats, TeamMatchStats awayStats, MatchStatus status, String? reasonCode, List<String> violatingTeamIds, bool isWalkover, bool noGkPenalty, List<String> noGkPenaltyTeamIds, MatchContext context, TacticsSetup homeTactics, TacticsSetup awayTactics, List<Player> homeLineup, List<Player> awayLineup, List<Position> homeLineupPositions, List<Position> awayLineupPositions, MatchTeamSnapshot homeSnapshot, MatchTeamSnapshot awaySnapshot, List<PlayerMatchStats> playerStats, List<MatchEvent> events, List<MatchInjury> injuries, List<MatchDiscipline> disciplines, String? manOfTheMatchPlayerId, String? inspiredPerformancePlayerId, bool wentToExtraTime, bool wentToShootout, int shootoutHomeGoals, int shootoutAwayGoals, String? winnerTeamId, int matchEndMinute, int stoppageTime
});
...
as String?,wentToExtraTime: null == wentToExtraTime ? _self.wentToExtraTime : wentToExtraTime // ignore: cast_nullable_to_non_nullable
as bool,wentToShootout: null == wentToShootout ? _self.wentToShootout : wentToShootout // ignore: cast_nullable_to_non_nullable
as bool,shootoutHomeGoals: null == shootoutHomeGoals ? _self.shootoutHomeGoals : shootoutHomeGoals // ignore: cast_nullable_to_non_nullable
as int,shootoutAwayGoals: null == shootoutAwayGoals ? _self.shootoutAwayGoals : shootoutAwayGoals // ignore: cast_nullable_to_non_nullable
...
class _MatchResult implements MatchResult {
  const _MatchResult({required this.homeTeamId, required this.awayTeamId, required this.homeGoals, required this.awayGoals, required this.homeStats, required this.awayStats, this.status = MatchStatus.played, this.reasonCode, final  List<String> violatingTeamIds = const [], this.isWalkover = false, this.noGkPenalty = false, final  List<String> noGkPenaltyTeamIds = const [], this.context = const MatchContext(), this.homeTactics = const TacticsSetup(), this.awayTactics = const TacticsSetup(), final  List<Player> homeLineup = const [], final  List<Player> awayLineup = const [], final  List<Position> homeLineupPositions = const [], final  List<Position> awayLineupPositions = const [], this.homeSnapshot = const MatchTeamSnapshot(), this.awaySnapshot = const MatchTeamSnapshot(), final  List<PlayerMatchStats> playerStats = const [], final  List<MatchEvent> events = const [], final  List<MatchInjury> injuries = const [], final  List<MatchDiscipline> disciplines = const [], this.manOfTheMatchPlayerId, this.inspiredPerformancePlayerId, this.wentToExtraTime = false, this.wentToShootout = false, this.shootoutHomeGoals = 0, this.shootoutAwayGoals = 0, this.winnerTeamId, this.matchEndMinute = 90, this.stoppageTime = 0}): _violatingTeamIds = violatingTeamIds,_noGkPenaltyTeamIds = noGkPenaltyTeamIds,_homeLineup = homeLineup,_awayLineup = awayLineup,_homeLineupPositions = homeLineupPositions,_awayLineupPositions = awayLineupPositions,_playerStats = playerStats,_events = events,_injuries = injuries,_disciplines = disciplines;
...
/// Shootout scores are not added to [homeGoals]/[awayGoals].
@override@JsonKey() final  bool wentToExtraTime;
@override@JsonKey() final  bool wentToShootout;
@override@JsonKey() final  int shootoutHomeGoals;
@override@JsonKey() final  int shootoutAwayGoals;
