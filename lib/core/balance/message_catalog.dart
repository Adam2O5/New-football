...
class MessageCatalog {
  static final List<MessageTemplate> templates = [
    ...
    _template(
      MessageType.retirementLeagueDigest,
      MessageDomain.roster,
      MessagePriority.silenced,
      titleKey: 'msg_retirementLeagueDigest_digest_title',
      bodyKey: 'msg_retirementLeagueDigest_digest_body',
      args: const ['count', 'week'],
      groupKey: 'retire:league:{week}',
      dedupKey: 'retire:league:{year}',
    ),
    for (final kind in [
      'mvp',
      'roty',
      ...
      _template(
        MessageType.award,
        MessageDomain.season,
        MessagePriority.normal,
        kind: kind,
        escalateIf: const [MessageEscalationPredicate.ownClub],
        args: const ['playerName', 'teamName', 'slot'],
        payload: const ['playerId', 'teamId', 'ownClub'],
        dedupKey: 'award:{year}:$kind',
      ),
    _template(
      MessageType.playoffSeeding,
      MessageDomain.season,
      MessagePriority.normal,
      args: const ['conference', 'seed7', 'seed8'],
      payload: const ['teamId'],
      dedupKey: 'playoffSeeding:{year}:{conference}',
    ),
    _template(
      MessageType.playInResult,
      MessageDomain.season,
      MessagePriority.normal,
      args: const ['conference', 'seed7', 'seed8'],
      payload: const ['teamId'],
      dedupKey: 'playInResult:{year}:{conference}',
    ),
  ...
  static const Map<MessageType, MessageDomain> _domains = {
    ...
    MessageType.playoffSeeding: MessageDomain.season,
    MessageType.playInResult: MessageDomain.season,
  ...
  static const Map<MessageType, MessagePriority> _priorities = {
    ...
    MessageType.playoffSeeding: MessagePriority.normal,
    MessageType.playInResult: MessagePriority.normal,
